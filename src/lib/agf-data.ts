export const SERVICES = [
  {
    ...
    title: "Fund Raising",
    blurb: "Local and international capital across syndicated loans, MTN issuance and private placements.",
    items: [
      "Loan Syndication",
  ...
  },
  {
    ...
    blurb: "End-to-end deal origination, structuring and execution for cross-border and domestic transactions.",
    items: [
  ...
  },
  {
    ...
    blurb: "Strengthen capital structure and reposition businesses for sustainable growth.",
    items: [
  ...
  },
  {
    ...
    blurb: "Shape a brighter future with structured strategy, risk and capital-market readiness work.",
    items: [
      "IPO Preparation",
...
export const MILESTONES = [
  {
    year: "2005",
    title: "Initiation",
    body: "AGF founded — risk management, business consultancy and the IPM (Institut Pengembangan Management) education arm.",
  },
  {
    year: "2010",
    title: "Business Expansion",
    body: "Entered the financial markets with loan syndication and financial advisory mandates.",
  },
  {
    year: "2015",
    title: "International Reach",
    body: "Fund raising in international markets and advisory work in capital markets.",
  },
  {
    year: "Today",
    title: "Corporate Actions",
    body: "Full-spectrum corporate actions: M&A, private placements of equity and debt, securitization and restructuring.",
  },
];

export const ACHIEVEMENTS = [
  { sector: "Retailer & Supermarkets (Bali)", type: "Loan Syndication", market: "International", currency: "USD", role: "Arranger" },
  { sector: "Producer of Honda Motor Frames", type: "Merger & Acquisition", market: "International", currency: "USD", role: "Consulting" },
  { sector: "Smart Card Producer", type: "Merger & Acquisition", market: "International", currency: "USD", role: "Consulting", logo: "/__l5e/assets-v1/ab30352f-4112-4070-be3b-c8264840cb9a/smart-card-logo.png" },
  ...
  { sector: "Wood-Processed Products Exporter", type: "Loan Syndication", market: "Indonesia", currency: "IDR", role: "Consulting" },
  { sector: "Wood-Processed Products Exporter", type: "Debt", market: "Indonesia", currency: "IDR", role: "Consulting" },
  { sector: "Hotel & Hospitality Company", type: "Debt", market: "Indonesia", currency: "IDR", role: "Arranger" },
  { sector: "Property & Investment Co.", type: "Debt", market: "Indonesia", currency: "IDR", role: "Arranger" },
  { sector: "General Contractor (SOE)", type: "Debt", market: "Indonesia", currency: "IDR", role: "Arranger" },
  { sector: "Defence Company", type: "Debt", market: "Indonesia", currency: "IDR", role: "Consulting" },
  { sector: "Tourism Development Co. (SOE)", type: "Restructuring", market: "Indonesia", currency: "IDR", role: "Consulting" },
  { sector: "Railway Systems (SOE Subsidiary)", type: "Loan Syndication", market: "Indonesia", currency: "IDR", role: "Arranger" },
  { sector: "Independent Power Producer", type: "Asset Securitization", market: "Indonesia", currency: "USD", role: "Consulting" },
  { sector: "EPC Company (SOE Subsidiary)", type: "Business Spin-off", market: "Indonesia", currency: "IDR", role: "Consulting" },
  { sector: "Textile & Fabrics Trading", type: "Loan Syndication", market: "Indonesia", currency: "IDR", role: "Arranger" },
  { sector: "Printing & Publishing Co.", type: "Debt", market: "Indonesia", currency: "IDR", role: "Arranger" },
  { sector: "Golf Course Sanur Bali", type: "Merger & Acquisition", market: "Indonesia", currency: "IDR", role: "Consulting" },
